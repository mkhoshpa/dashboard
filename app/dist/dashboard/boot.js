...
(function (app) {
    ...
    (function (dashboard) {
        angular
            ...
            'users', 'response', 'md.data.table'])
            .controller('MainController', ['$scope', 'userService', 'responseService', '$mdSidenav', '$mdBottomSheet', '$mdToast', '$mdDialog', '$mdMedia', '$http', dashboard.MainController])
