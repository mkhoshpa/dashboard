...
(function (app) {
    var dashboard;
    (function (dashboard) {
        var SurveyBuilderController = (function () {
            function SurveyBuilderController($mdDialog, userService, $http, selected) {
            ...
            /*
            SurveyBuilderController.prototype.editSurvey = function (survey) {
                console.log('here');
            };
            */
            ...
            SurveyBuilderController.prototype.close = function () {
                this.$mdDialog.cancel();
            };
            SurveyBuilderController.prototype.save = function () {
                var survey = {};
            ...
            SurveyBuilderController.$inject = ['$mdDialog', 'userService', '$http', 'selected'];
            return SurveyBuilderController;
        }());
        dashboard.SurveyBuilderController = SurveyBuilderController;
    })(dashboard = app.dashboard || (app.dashboard = {}));
})(app || (app = {}));
//# sourceMappingURL=surveyBuilderController.js.map
